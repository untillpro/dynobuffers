...
func BenchmarkReadFlatBuffersSimpleString(b *testing.B) {
	bl := flatbuffers.NewBuilder(0)
	colaName := bl.CreateString("cola")
	SaleStart(bl)
	SaleAddName(bl, colaName)
...
func BenchmarkReadJsonSimple(b *testing.B) {
...
func BenchmarkReadLinkedInAvroSimple(b *testing.B) {
...
func BenchmarkReadFlatBuffersArticleReadFewFields(b *testing.B) {
	bl := flatbuffers.NewBuilder(0)
...
func BenchmarkReadLinkedInAvroArticleReadFewFields(b *testing.B) {
...
func BenchmarkReadFlatBuffersArticleReadAllFields(b *testing.B) {
	bl := flatbuffers.NewBuilder(0)
	a := fillArticleFlatBuffers(bl)
	bl.Finish(a)
	bytes := bl.FinishedBytes()
...
func BenchmarkReadJsonArticleReadAllFields(b *testing.B) {
